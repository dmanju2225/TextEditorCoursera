...
public class BasicDocument extends Document 
{
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		List<String> numSentences = new ArrayList<String>();
		
		numSentences=getTokens("[^.!?]+");
		//System.out.println("numSentences is:"+numSentences);
	...
	int finalcount;
        for(int i=0;i<wordlist.size();i++){
        	 finalcount=countSyllables(wordlist.get(i));
        	wordcount=wordcount+finalcount;
        }
        return wordcount;
	}
