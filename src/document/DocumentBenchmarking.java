...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String textToRead=getStringFromFile("data/warAndPeace.txt",numToCheck);
			...
			long basicTimeTaken=(endTime-startTime)/100000000;
			System.out.print(" "+basicTimeTaken+"\t");
			...
			long efficientTimeTaken=(endTime1-startTime1)/100000000;
			System.out.print(" "+efficientTimeTaken+"\t");
			System.out.println();
